...
export default function Profile() {
  ...
  const [upadteSuccess, setUpdateSuccess] = useState(false);
  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <p>{upadteSuccess ? "user is updated successfully" : ""}</p>

      <button onClick={handleShowListings} className="text-green-700 w-full">Show Listings</button>
      <p className="text-red-700 mt-5">{showListingsError ? "Error showing lists..." : ""}</p>

      {userListings && userListings.length > 0 && 
        <div className="flex flex-col gap-4"> 
          <h1 className="text-slate-700 font-bold text-center mt-7 text-2xl"> Your Listings.</h1>
